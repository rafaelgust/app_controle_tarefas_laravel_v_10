...
class RedefinirSenhaNotification extends Notification
{
    ...
    public function toMail($notifiable)
    {
        ...
        $saudacao = sprintf('Olá, %s!', $notifiable->name);
        ...
        return (new MailMessage)
            ...
            ->line(Lang::get('Este link para redefinição de senha irá expirar em :count minutos.', ['count' => config('auth.passwords.'.config('auth.defaults.passwords').'.expire')]))
            ->line(Lang::get('Se você não solicitou uma redefinição de senha, nenhuma ação adicional é necessária.'))
            ->salutation(Lang::get('Atenciosamente,') . PHP_EOL . config('app.name'));
    }
